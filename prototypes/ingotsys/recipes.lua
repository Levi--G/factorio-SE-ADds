...
if settings.startup[constants.setting_ingotsys].value then
    if (data.raw.item["se-iron-ingot"] and data.raw.item["se-copper-ingot"] and data.raw.item["se-steel-ingot"]) then
